...
class GammaVac(QWeatherServer):
    ...
    def __init__(self, name = None):
        ...
        if name is None:
            ...
            self.servername = name + 'VacuumPump'
        self.verbose = False
        self.debug = False
        self.demo = False
    ...
    def initialize_hardware(self):
        ...
        self.analog_input_1 = arduino.get_pin('a:1:i')
        self.digital_input_0 = arduino.get_pin('d:0:i')
        self.digital_input_1 = arduino.get_pin('d:1:i')
