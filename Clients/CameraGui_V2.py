...
class CamGui(QWidget):
    ...
    def write_logmessage(self,message):
...
#        self.fitresults = poptarts
    ...
    def save_clicked(self):
        self.resultarray = []
        self.savebutton.setText('Save 10 Images ({:d})'.format(len(self.resultarray)//3))
        self.saving = True
...
#            if True:
#                if self.saving:
#                    self.savebutton.setText('Save 10 Images {:d}'.format(len(self.resultarray)))
#                
...
#                        self.savebutton.setText('Save 10 Images {:d}'.format(len(self.resultarray)-i))
#                self.saving = False
#                self.resultarray = []
    ...
    def make_buttonspanel(self):
        panel = QFrame()
        self.savebutton = QPushButton('Save 10 Images (0)')
